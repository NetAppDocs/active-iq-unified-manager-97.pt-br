...
Você pode usar esse arquivo de log para encontrar a causa raiz de qualquer problema que ocorra durante o início, parada ou implantação do servidor Widlfly.
