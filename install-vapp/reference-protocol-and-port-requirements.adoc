...
Usado para habilitar o acesso aos Serviços de API do OnCommand Workflow Automation e do OnCommand ao Unified Manager.
 ...
 a| 
MySQL Database Extended Interface (o protocolo MySQL X)
 a| 
MySQL
 a| 
33060
...
[NOTE]
====
As portas usadas para comunicação HTTP e HTTPS (portas 80 e 443) podem ser alteradas usando o console de manutenção do Unified Manager. Para obter mais informações, link:../config/concept-maintenance-console-menu.html["Menus da consola de manutenção"]consulte .
